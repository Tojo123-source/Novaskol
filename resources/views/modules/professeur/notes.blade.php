...
<style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; scrollbar-width:thin; scrollbar-color:#2a2a3a #0f0f11; }
    ...
    header h1,header .header-center { margin:0; line-height:1.15; min-width:0; max-width:100%; padding:0 170px 0 84px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-align:center; }
...
<header>
    ...
    <div class="header-center"><i class="fa fa-book"></i> Ajout des notes par classe</div>
</header>
<main>
