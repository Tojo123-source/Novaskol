(function() {
    ...
    var QRCode = function(canvas, text) {
        ...
        var cellSize = Math.floor(Math.min(canvas.width, canvas.height) / size);
        var offsetX = Math.floor((canvas.width - cellSize * size) / 2);
        var offsetY = Math.floor((canvas.height - cellSize * size) / 2);
