@echo off
REM ============================================
REM  NOVASKOL DESKTOP - CLEAN REBUILD v1.0.5
REM ============================================
...
echo.
echo ============================================
echo   NOVASKOL DESKTOP - CLEAN REBUILD
echo   Version 1.0.5
echo ============================================
echo.
...
if exist "storage\app\desktop-dist" (
    echo   Removing: storage\app\desktop-dist
    rmdir /s /q "storage\app\desktop-dist"
    if exist "storage\app\desktop-dist" (
...
echo.
echo [4/8] Navigating to desktop directory...
cd /d "%ROOT_DIR%\desktop"
if not exist "package.json" (
    echo   [ERROR] package.json not found!
    exit /b 1
)
echo   [OK] In desktop directory
...
if exist "storage\app\desktop-dist\Novaskol-Setup-1.0.5-x64.exe" (
    for %%F in ("storage\app\desktop-dist\Novaskol-Setup-1.0.5-x64.exe") do (
